<main>
    <div class="container">
	    <div class="row">
		    ...
		    <!-- Content -->
		    <div class="col-sm-9">
			    <h1 class="page-header"><span>e</span>Scan Enterprise Edition <span>with</span> Cloud Security</h1>

			    <div class="row">
				    <div class="col-sm-4">
					    <!-- Image -->
					    <img src="/assets/img/enterprise/enterprise-boxshot.png" class="img-responsive">
				    </div>

				    <div class="col-sm-8">
					    <p>To ensure complete security of the IT infrastructure against the increasing number of vulnerabilities, businesses need effective security solution that not only efficiently secure but also help manage the protection of the server and endpoints.</p>
